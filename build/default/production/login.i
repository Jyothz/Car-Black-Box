...
unsigned char login_BB(unsigned char);
void read_password(unsigned char *);
# 11 "login.c" 2
        ...
        else
        {
            ...
            else
            {
                ...
                while(!flag_2_min)
                {
                    ...
                    {
                        flag_1_sec = 0;
                    clcd_putch(((min_2/100)+48),(0xC0 + (9)));
                    clcd_putch((((min_2%100)/10)+48),(0xC0 + (10)));
                    clcd_putch(((min_2%10)+48),(0xC0 + (11)));
                    min_2--;
                    }
                }
                TMR0IE = 0;
...
{
    psw_arr[0] = (read_external_eeprom(0x34)+48);
    psw_arr[1] = (read_external_eeprom(0x34 +1)+48);
    psw_arr[2] = (read_external_eeprom(0x34 +2)+48);
    psw_arr[3] = (read_external_eeprom(0x34 +3)+48);
    psw_arr[4] = '\0';
}
