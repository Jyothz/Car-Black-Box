...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/P1_car_black_box.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=main.c clcd.c matrix_keypad.c timer.c isr.c adc.c login.c menu.c rtc.c i2c.c ext_eeprom.c dashboard.c uart.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/clcd.p1 ${OBJECTDIR}/matrix_keypad.p1 ${OBJECTDIR}/timer.p1 ${OBJECTDIR}/isr.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/login.p1 ${OBJECTDIR}/menu.p1 ${OBJECTDIR}/rtc.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/ext_eeprom.p1 ${OBJECTDIR}/dashboard.p1 ${OBJECTDIR}/uart.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/clcd.p1.d ${OBJECTDIR}/matrix_keypad.p1.d ${OBJECTDIR}/timer.p1.d ${OBJECTDIR}/isr.p1.d ${OBJECTDIR}/adc.p1.d ${OBJECTDIR}/login.p1.d ${OBJECTDIR}/menu.p1.d ${OBJECTDIR}/rtc.p1.d ${OBJECTDIR}/i2c.p1.d ${OBJECTDIR}/ext_eeprom.p1.d ${OBJECTDIR}/dashboard.p1.d ${OBJECTDIR}/uart.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.p1 ${OBJECTDIR}/clcd.p1 ${OBJECTDIR}/matrix_keypad.p1 ${OBJECTDIR}/timer.p1 ${OBJECTDIR}/isr.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/login.p1 ${OBJECTDIR}/menu.p1 ${OBJECTDIR}/rtc.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/ext_eeprom.p1 ${OBJECTDIR}/dashboard.p1 ${OBJECTDIR}/uart.p1

# Source Files
SOURCEFILES=main.c clcd.c matrix_keypad.c timer.c isr.c adc.c login.c menu.c rtc.c i2c.c ext_eeprom.c dashboard.c uart.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/P1_car_black_box.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/P1_car_black_box.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/P1_car_black_box.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp=${DFP_DIR}/xc8  -fno-short-double -fno-short-float -memi=wordwrite -mrom=0-3000 -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/P1_car_black_box.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/P1_car_black_box.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/P1_car_black_box.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/P1_car_black_box.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp=${DFP_DIR}/xc8  -fno-short-double -fno-short-float -memi=wordwrite -mrom=0-3000 -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/P1_car_black_box.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
